...
class Controller
{
    ...
    std::string buildApplicationMessage(const std::string &msg_type, const std::vector<Field> &fields = {});
    ...
    std::string buildMessage(const std::string &msg_type, const std::vector<Field> &fields);
    std::string
